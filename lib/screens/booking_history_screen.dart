                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text('Rp ${booking['total_price'] ?? 0}', style: TextStyle(color: Colors.white)),
                          ),
                        ],
                      ),
                      SizedBox(height: 10),
                      ...
                      Center(
                        child: Column(
                          children: [
                            Text('Booking QR Code', style: TextStyle(fontWeight: FontWeight.bold)),
                            SizedBox(height: 10),
                            QrImageView(data: bookingId, version: QrVersions.auto, size: 150),
                            SizedBox(height: 10),
                            Text('ID: ${bookingId.substring(0, 8)}...', style: TextStyle(fontSize: 12, color: Colors.grey)),
                          ],
                        ),
                      ),
                    ],
